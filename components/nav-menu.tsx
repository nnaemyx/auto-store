  ...
  return (
    <div className="bg-white flex flex-col space-y-4">
      ...
      <Link href="/favorites" className="flex items-center gap-2 px-3 py-2.5">
        ...
        <span className="text-[15px] font-[450] tracking-[-3%]">My favourites</span>
      </Link>

      <Link href="/auth/signup" className="flex items-center gap-2 px-3 py-2.5">
        <User className="h-4.5 w-4.5" />
        <span className="text-[15px] font-[450] tracking-[-3%]">Register</span>
      </Link>

      <Link href="/support" className="flex items-center gap-2 px-3 py-2.5">
        <HelpCircle className="h-4.5 w-4.5" />
        <span className="text-[15px] font-[450] tracking-[-3%]">Contact support</span>
      </Link>
      ...
      <Button
        variant="ghost"
        className="flex items-center justify-start gap-2 px-3 py-2.5 text-red-500 hover:text-red-700 hover:bg-red-50"
      >
