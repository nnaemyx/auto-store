            ...
            <Image
              src={
                ...
                (product.images && product.images.length > 0
                  ...
                  : "https://res.cloudinary.com/mmainspire/image/upload/v1743250733/real-estate/yuhrmm3hxaod88pjukpo.jpg")
              }
              alt={product.name}
              fill
            ...
            <div className="flex">
              {[...Array(5)].map((_, i) => (
                <Star
                  key={i}
                  className={`h-4 w-4 ${
                    i < Number.parseInt(product.rating)
          ...
          <div className="text-sm text-gray-500 space-y-1">
            ...
            {product.manufacturer_id && (
              <p>
                Brand:{" "}
                <Link
                  href={`/brand/${product.manufacturer_id}`}
