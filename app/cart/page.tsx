    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center py-12">
          <h2 className="text-xl font-bold text-red-500 mb-2">Error Loading Cart</h2>
          <p className="text-gray-600 mb-4">Failed to load your cart items. Please try again later.</p>
          <Button asChild>
              ...
              <div key={item.id} className="bg-white rounded-lg overflow-hidden shadow-sm border">
                <div className="flex flex-col sm:flex-row p-4 gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-bold mt-2">₦{Number(item.amount).toLocaleString()}</p>
                      ...
                      <div className="flex justify-between items-end mt-4">
                        <div className="flex items-center">
                          <Button
                            ...
                            size="icon"
                            className="h-8 w-8"
                            onClick={() => handleQuantityChange(item.id, Number.parseInt(item.quantity) - 1)}
                            disabled={isUpdatingQuantity || Number.parseInt(item.quantity) <= 1}
                          >
          ...
          <div className="bg-white rounded-lg border p-6 sticky top-24">
            ...
            <div className="space-y-4">
              <div className="flex justify-between">
                ...
                <span className="font-medium">₦{cart.summary.subtotal.toLocaleString()}</span>
              </div>
            ...
            <Button className="w-full mt-6 bg-black hover:bg-gray-800 text-white">Check Out</Button>
          </div>
        </div>
      </div>
    </div>
